...
namespace TeamTracker
{
    public class CustomDatetimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = UserInterface.Properties.Resources.calendar1;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = UserInterface.Properties.Resources.calendar1;
                else calendarIcon = UserInterface.Properties.Resources.calendar1;
                this.Invalidate();
            }
        }
