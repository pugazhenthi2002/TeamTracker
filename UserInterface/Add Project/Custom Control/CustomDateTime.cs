...
{
    class CustomDateTime:DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = UserInterface.Properties.Resources.Calendar_30;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (StringFormat textFormat = new StringFormat())
            {
                ...
                //Draw icon
                graphics.DrawImage(calendarIcon, this.Width - calendarIcon.Width - 7, (this.Height - calendarIcon.Height - 2), calendarIcon.Width, calendarIcon.Height);
